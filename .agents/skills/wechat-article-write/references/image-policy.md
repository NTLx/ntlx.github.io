...
`EXTEND.md` 是 bright、vivid、high saturation、high contrast、clean、crisp、warm-positive
的项目偏好和 `prefer-reuse` 原图策略。具体 style、layout、palette、preset 只由被委托 Skill 决定。
