...
| Step 5 prepared | `gzh-design` owner → HTML validator/preview → build-finalize Gate |
| gzh 或 Step 5 structural/integrity 失败 | `gzh-design` owner → frozen source → 同一 Gate |
