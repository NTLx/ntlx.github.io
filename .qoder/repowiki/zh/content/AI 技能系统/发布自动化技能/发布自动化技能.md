...
## 更新摘要
**变更内容**
- 微信文章写作技能从15步流程简化为6步流水线，实现了真正的双轨分离架构
- 新增最小编排器 pipeline.mjs，支持自动执行确定性步骤
- 实现双轨分离：博客轨消费 Markdown + CDN URL，微信轨消费本地 HTML + 本地图片
- 移除CDN回退机制，简化双产物机制
- 更新发布顺序：先博客后微信，确保sourceUrl稳定性
- 新增post-draft.mjs桥接脚本，优化微信发布流程
- 增强状态管理系统，支持Step 6子状态跟踪
...
- **wechat-article-write**
  ...
  - **最小编排器**：pipeline.mjs 支持自动执行确定性步骤（Step 5/6）
...
**章节来源**
- [.agents/skills/wechat-article-write/SKILL.md:14-16](file://.agents/skills/wechat-article-write/SKILL.md#L14-L16)
- [.agents/skills/wechat-article-write/scripts/state.mjs:1-84](file://.agents/skills/wechat-article-write/scripts/state.mjs#L1-L84)
- [.agents/skills/wechat-article-write/scripts/state-lib.mjs:1-150](file://.agents/skills/wechat-article-write/scripts/state-lib.mjs#L1-L150)
...
- [.agents/skills/wechat-article-write/scripts/publish-blog.mjs:1-335](file://.agents/skills/wechat-article-write/scripts/publish-blog.mjs#L1-L335)
- [.agents/skills/wechat-article-write/scripts/publish-wechat.mjs:1-153](file://.agents/skills/wechat-article-write/scripts/publish-wechat.mjs#L1-L153)
- [.agents/skills/wechat-article-write/scripts/step5-build.mjs:1-192](file://.agents/skills/wechat-article-write/scripts/step5-build.mjs#L1-L192)
...
**图表来源**
- [.agents/skills/wechat-article-write/SKILL.md:48-60](file://.agents/skills/wechat-article-write/SKILL.md#L48-L60)
...
- **Step 6子状态**：博客/微信发布分别跟踪，支持独立失败处理

#### 最小编排器
- **pipeline.mjs**：支持自动执行确定性步骤（Step 5/6），非确定性步骤需要Agent手动执行
- **断点续跑**：通过state.mjs next查看当前步骤，支持失败后恢复
...
**章节来源**
- [.agents/skills/wechat-article-write/SKILL.md:14-282](file://.agents/skills/wechat-article-write/SKILL.md#L14-L282)
- [.agents/skills/wechat-article-write/scripts/state.mjs:1-84](file://.agents/skills/wechat-article-write/scripts/state.mjs#L1-L84)
- [.agents/skills/wechat-article-write/scripts/state-lib.mjs:1-150](file://.agents/skills/wechat-article-write/scripts/state-lib.mjs#L1-L150)
- [.agents/skills/wechat-article-write/scripts/pipeline.mjs:1-148](file://.agents/skills/wechat-article-write/scripts/pipeline.mjs#L1-L148)
- [.agents/skills/wechat-article-write/scripts/publish-blog.mjs:1-335](file://.agents/skills/wechat-article-write/scripts/publish-blog.mjs#L1-L335)
...
A --> K["pipeline.mjs"]
L["wechat-api.ts"] --> M["@jsquash/webp"]
L --> N["baoyu-md"]
L --> O["jimp"]
P["post-draft.mjs"] --> L
Q["upload.ts"] --> R["gh CLI"]
```
...
- **状态管理优化**
  ...
  - 断点续跑支持，减少重复执行
  - Step 6子状态独立跟踪，提高并发处理能力
- **最小编排器优化**
  - pipeline.mjs 支持 --auto 参数自动执行确定性步骤
  - 非确定性步骤需要Agent手动干预，避免误操作
- **图片处理优化**
...
- **状态管理问题**
  ...
  - Step 6子状态异常：使用state.mjs blog/wechat查看具体状态
- **双轨分离问题**
  - 博客轨CDN URL错误：检查article.md中的占位符替换是否正确执行
  - 微信轨本地路径错误：检查article-wechat.html中的本地图片路径
  - HTML转换失败：检查article.md格式和主题配置
- **最小编排器问题**
  - pipeline.mjs --auto 失败：检查Step 5/6前置条件是否满足
  - 非确定性步骤卡住：需要Agent手动完成Step 1-4
