...
![](https://cdn.jsdelivr.net/gh/NTLx/Pic@master/wechat-articles/2026-05-20-coding-agent-sensors-img-00-infographic-core-summary.png)
...
![](https://cdn.jsdelivr.net/gh/NTLx/Pic@master/wechat-articles/2026-05-20-coding-agent-sensors-img-01-comparison-prompt-vs-sensors.png)

如果把这篇文章压成一张更直觉的图，我脑子里更接近上面这种对比：左边是只靠 prompt 狂奔的 agent，右边是一路被 type、lint、test 和结构信号不断拉回来的 agent。Birgitta 原文那张总览图更工程，也更完整；而我自己读完以后，最先留下来的其实就是这个差别。很多团队现在出问题，不是没配工具，而是把这些工具全当成孤立插件看，没有把它们当成同一条反馈链上的不同节点。
...
![](https://cdn.jsdelivr.net/gh/NTLx/Pic@master/wechat-articles/2026-05-20-coding-agent-sensors-img-02-framework-real-app-context.png)
...
![](https://cdn.jsdelivr.net/gh/NTLx/Pic@master/wechat-articles/2026-05-20-coding-agent-sensors-img-03-flowchart-shift-left-feedback.png)
